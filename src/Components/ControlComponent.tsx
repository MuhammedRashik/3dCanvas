    ...
    <>
      <div className="w-full flex  items-center h-full p-10 justify-center gap-10">
        {objects.map((obj: any, index: number) => (
          <div
            key={index}
            className="w-64 h-48 rounded-md  border  flex flex-col"
          >
            <div className="w-full h-1/2 flex justify-between  items-center p-4 gap-2 ">
              <div className="w-1/2 h-full  flex justify-center items-center">
                <button
                  onClick={() => toggleVisibility(index)}
                  className="w-28 bg-blue-500 h-10 rounded-md  text-white hover:bg-blue-600"
                >
              ...
              <div className="w-1/2 h-full  flex justify-center items-center">
                <button
                  ...
                  className="w-32 bg-blue-500 h-10 rounded-md  text-white hover:bg-blue-600"
                >
            ...
            <div className="w-full h-1/2 flex flex-col ">
              <div className="w-full  h-7 justify-start pl-5 items-center text-gray-400 ">
                {" "}
                Rotation Speed:
              </div>
